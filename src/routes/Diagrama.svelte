...
<section class="section-with-diagram section pb-0 js-section-with-diagram">
  <div class="h2 section-with-diagram__title">Персональный расчет</div>
  ...
  <div class="section-with-diagram__top-content">
    <div class="section-with-diagram__col-with-table">
      ...
      <table
        class="section-with-diagram__table table health-table js-health-table"
      >
        <thead>
          <tr>
            <th scope="col"></th>
        ...
        <tbody>
          <tr class="-purple-row" data-row-number="1">
            <th scope="row">1</th>
            <td>
              <div class="h5 table-title-with-prompt">
                <span class="table-title-with-prompt__text">Сахасрара</span>
                <i
                  class="table-title-with-prompt__icon icomoon-prompt js-popover"
                  data-content="Отвечает за состояние волос, мозга и верхней части черепа."
                  data-original-title=""
                  title=""
                ></i>
              </div>
              <div class="h6 table-sub-title">Миссия</div>
            </td>
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="a">4</td
            >
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="b">12</td
            >
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="l">16</td
            >
          </tr>
          <tr class="-blue-row -active" data-row-number="2">
            <th scope="row">2</th>
            <td>
              <div class="h5 table-title-with-prompt">
                <span class="table-title-with-prompt__text">Аджна</span>
                <i
                  class="table-title-with-prompt__icon icomoon-prompt js-popover"
              ...
              <div class="h6 table-sub-title">Судьба, эгрегоры</div>
            </td>
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="a2">15</td
            >
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="b2">4</td
            >
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="l1">19</td
            >
          </tr>
          <tr class="-cyan-row -active" data-row-number="3">
            <th scope="row">3</th>
            <td>
              <div class="h5 table-title-with-prompt">
                <span class="table-title-with-prompt__text">Вишудха</span>
                <i
                  class="table-title-with-prompt__icon icomoon-prompt js-popover"
            ...
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="a1">11</td
            >
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="b1">19</td
            >
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="l2">3</td
            >
          </tr>
          <tr class="-green-row -active" data-row-number="4">
            <th scope="row">4</th>
            <td>
              <div class="h5 table-title-with-prompt">
                <span class="table-title-with-prompt__text">Анахата</span>
                <i
                  class="table-title-with-prompt__icon icomoon-prompt js-popover"
              ...
              <div class="h6 table-sub-title">Отношения, картина мира</div>
            </td>
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="a3">18</td
            >
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="b3">8</td
            >
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="l3">8</td
            >
          </tr>
          <tr class="-yellow-row" data-row-number="5">
            ...
            <td>
              <div class="h5 table-title-with-prompt">
                <span class="table-title-with-prompt__text">Манипура</span>
                <i
                  class="table-title-with-prompt__icon icomoon-prompt js-popover"
              ...
              <div class="h6 table-sub-title">Статус, владение</div>
            </td>
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="e">7</td
            >
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="e">7</td
            ...
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="l4">14</td
            >
          </tr>
          <tr class="-orange-row -active" data-row-number="6">
            <th scope="row">6</th>
            <td>
              <div class="h5 table-title-with-prompt">
                <span class="table-title-with-prompt__text">Свадхистана</span>
                <i
                  class="table-title-with-prompt__icon icomoon-prompt js-popover"
              ...
              <div class="h6 table-sub-title">Детская любовь и радость</div>
            </td>
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="c1">8</td
            >
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="d1">15</td
            >
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="l5">5</td
            >
          </tr>
          <tr class="-red-row -active" data-row-number="7">
            <th scope="row">7</th>
            <td>
              <div class="h5 table-title-with-prompt">
                <span class="table-title-with-prompt__text">Муладхара</span>
                <i
                  class="table-title-with-prompt__icon icomoon-prompt js-popover"
              ...
              <div class="h6 table-sub-title">Тело, материя</div>
            </td>
            <td
              class="js-personal-calculation-item -active"
              data-personal-calculation-position="c">19</td
            >
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="d">8</td
            >
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="l6">9</td
            >
          </tr>
          <tr class="-gray-row" data-row-number="8">
            ...
            <td>
              <div class="h5 table-title-with-prompt">
                <span class="table-title-with-prompt__text">Итог</span>
                <i
                  class="table-title-with-prompt__icon icomoon-prompt js-popover"
            ...
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="d3">10</td
            >
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="c3">10</td
            >
            <td
              class="js-personal-calculation-item"
              data-personal-calculation-position="e3">11</td
            >
          </tr>
        </tbody>
      </table>
      ...
      <ul class="diagram-values-list">
        <li class="diagram-values-list__item">
          <div class="diagram-values-item-horizontal">
            <div class="h6 diagram-values-item-horizontal__title">
              Родовые программы по мужской линии:
            </div>

            <ul
              class="diagram-values-item-horizontal__values round-values-list"
            >
              <li class="round-values-list__item">
                <div
                  class="diagram-value js-personal-calculation-item -active"
        ...
        <li class="diagram-values-list__item">
          <div class="diagram-values-item-horizontal">
            ...
            >
              ...
              <li class="round-values-list__item">
                <div
                  class="diagram-value js-personal-calculation-item"
        ...
        <div class="matrix-diagram">
          <div class="matrix-diagram__svg">
            <svg
              ...
              ><path d="M1616.74 0H0v1616.74h1616.74V0z" fill="#fff"
              ></path><path opacity=".5" d="M1607 0H0v1617h1607V0z" fill="#fff"
              ></path><path
                fill-rule="evenodd"
                clip-rule="evenodd"
          ...
          <!-- circles -->
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-lg -position-a -purple"
            data-personal-calculation-position="a"
          >
            4
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-md -position-a2 -blue -active"
            data-personal-calculation-position="a2"
          >
            15
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-a1 -cyan -active"
            data-personal-calculation-position="a1"
          >
            11
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-a3 -green -active"
            data-personal-calculation-position="a3"
          >
            18
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-lg -position-b -purple"
            data-personal-calculation-position="b"
          >
            12
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-md -position-b2 -blue -active"
            data-personal-calculation-position="b2"
          >
            4
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-b1 -cyan -active"
            data-personal-calculation-position="b1"
          >
            19
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-b3 -green -active"
            data-personal-calculation-position="b3"
          >
            8
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-lg -position-c -red -active"
            data-personal-calculation-position="c"
          >
            19
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-md -position-c2 -white -active"
            data-personal-calculation-position="c2"
          >
            9
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-c1 -orange -active"
            data-personal-calculation-position="c1"
          >
            8
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-lg -position-d -red"
            data-personal-calculation-position="d"
          >
            8
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-md -position-d2 -white"
            data-personal-calculation-position="d2"
          >
            5
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-d1 -orange"
            data-personal-calculation-position="d1"
          >
            15
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-lg -position-e -yellow"
            data-personal-calculation-position="e"
          >
            7
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-md -position-e1 -white"
            data-personal-calculation-position="e1"
          >
            5
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-e2 -white"
            data-personal-calculation-position="e2"
          >
            12
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-lg -position-f -white -active"
            data-personal-calculation-position="f"
          >
            16
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-lg -position-g -white -active"
            data-personal-calculation-position="g"
          >
            4
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-lg -position-y -white -active"
            data-personal-calculation-position="y"
          >
            9
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-p1 -white -active"
            data-personal-calculation-position="p1"
          >
            9
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-md -position-p2 -white -active"
            data-personal-calculation-position="p2"
          >
            13
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-p3 -white -active"
            data-personal-calculation-position="p3"
          >
            17
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-md -position-p4 -white -active"
            data-personal-calculation-position="p4"
          >
            11
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-lg -position-k -white -active"
            data-personal-calculation-position="k"
          >
            12
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-s1 -white"
            data-personal-calculation-position="s1"
          >
            21
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-md -position-s2 -white"
            data-personal-calculation-position="s2"
          >
            10
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-md -position-s3 -white -active"
            data-personal-calculation-position="s3"
          >
            5
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-s4 -white -active"
            data-personal-calculation-position="s4"
          >
            14
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-x -white -active"
            data-personal-calculation-position="x"
          >
            5
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-x1 -white"
            data-personal-calculation-position="x1"
          >
            20
          </div>
          <div
            class="matrix-diagram__circle js-personal-calculation-item -size-sm -position-x2 -white -active"
          ...
          <!-- numbers -->
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-b8"
            data-personal-calculation-position="b8"
          >
            22
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-b7"
            data-personal-calculation-position="b7"
          >
            10
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-k2"
            data-personal-calculation-position="k2"
          >
            8
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-k1 -bold"
            data-personal-calculation-position="k1"
          >
            16
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-k4"
            data-personal-calculation-position="k4"
          >
            9
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-k3"
            data-personal-calculation-position="k3"
          >
            20
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-k5"
          ...
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-k8"
            data-personal-calculation-position="k8"
          >
            13
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-k7"
            data-personal-calculation-position="k7"
          >
            9
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-k6"
            data-personal-calculation-position="k6"
          >
            14
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-c4 -bold"
            data-personal-calculation-position="c4"
          >
            5
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-c6"
            data-personal-calculation-position="c6"
          >
            11
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-c5"
            data-personal-calculation-position="c5"
          >
            6
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-c7"
          ...
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-y3"
            data-personal-calculation-position="y3"
          >
            3
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-y2"
            data-personal-calculation-position="y2"
          >
            11
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-y4"
            data-personal-calculation-position="y4"
          >
            21
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-y1 -bold"
            data-personal-calculation-position="y1"
          >
            10
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-y6"
            data-personal-calculation-position="y6"
          >
            11
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-y5"
            data-personal-calculation-position="y5"
          >
            19
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-y7"
          ...
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-d6"
            data-personal-calculation-position="d6"
          >
            17
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-y8"
            data-personal-calculation-position="y8"
          >
            8
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-d5"
            data-personal-calculation-position="d5"
          >
            7
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-d4 -bold"
            data-personal-calculation-position="d4"
          >
            17
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-d8"
            data-personal-calculation-position="d8"
          >
            6
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-d7"
            data-personal-calculation-position="d7"
          >
            7
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-d9"
          ...
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-g3"
            data-personal-calculation-position="g3"
          >
            18
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-g2"
            data-personal-calculation-position="g2"
          >
            10
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-g4"
            data-personal-calculation-position="g4"
          >
            3
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-g1 -bold"
            data-personal-calculation-position="g1"
          >
            20
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-g7"
            data-personal-calculation-position="g7"
          >
            7
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-g5"
            data-personal-calculation-position="g5"
          >
            5
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-g6"
          ...
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-t3"
            data-personal-calculation-position="t3"
          >
            22
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-t2"
            data-personal-calculation-position="t2"
          >
            10
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-t4"
            data-personal-calculation-position="t4"
          >
            8
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-t1 -bold"
            data-personal-calculation-position="t1"
          >
            16
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-t6"
            data-personal-calculation-position="t6"
          >
            9
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-t5"
            data-personal-calculation-position="t5"
          >
            20
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-t7"
          ...
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-a5"
            data-personal-calculation-position="a5"
          >
            10
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-a4"
            data-personal-calculation-position="a4"
          >
            6
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-a6"
            data-personal-calculation-position="a6"
          >
            8
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-f1 -bold"
            data-personal-calculation-position="f1"
          >
            20
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-f3"
            data-personal-calculation-position="f3"
          >
            11
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-f2"
            data-personal-calculation-position="f2"
          >
            9
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-f4"
          ...
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-f7"
            data-personal-calculation-position="f7"
          >
            6
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-f6"
            data-personal-calculation-position="f6"
          >
            8
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-f8"
            data-personal-calculation-position="f8"
          >
            18
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-f5 -bold"
            data-personal-calculation-position="f5"
          >
            10
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-b5"
            data-personal-calculation-position="b5"
          >
            5
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-b4"
            data-personal-calculation-position="b4"
          >
            22
          </div>
          <div
            class="matrix-diagram__number js-personal-calculation-item -position-b6"
  ...
  <div class="section-with-diagram__bottom-values-row row">
    <div class="col">
      <div class="diagram-values-item">
        <div class="h6 diagram-values-item__title">Поиск себя</div>
          ...
          <div class="small-diagram-values__values-block">
            <div class="small-diagram-values__path-img">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M0 0V2H18V46H0V48H20V25H38V23H20V0H0Z" fill="#222831"
                ></path>
              </svg>
            </div>
            <div
              class="small-diagram-values__value js-personal-calculation-item -top-left diagram-value -active"
              data-personal-calculation-position="h"
            >
              20
            </div>
            <div
              class="small-diagram-values__value js-personal-calculation-item -bottom-left diagram-value -active"
              data-personal-calculation-position="j"
            >
              5
            </div>
            <div
              class="small-diagram-values__value js-personal-calculation-item -center diagram-value -active"
    ...
    <div class="col">
      <div class="diagram-values-item">
        <div class="h6 diagram-values-item__title">Социализация</div>
        <div class="diagram-values-item__description text-block">
          <p>Социальная и родовая системы. Результаты и признания в социуме.</p>
        </div>

        <div class="small-diagram-values">
          <div class="small-diagram-values__titles-block">
            <div class="h6 small-diagram-values__title">М</div>
            <div class="h6 small-diagram-values__title">Ж</div>
          </div>
          <div class="small-diagram-values__values-block">
            <div class="small-diagram-values__path-img">
              <svg
    ...
    <div class="col">
      <div class="diagram-values-item">
        <div class="h6 diagram-values-item__title">Духовная грамотность</div>
        <div class="diagram-values-item__description text-block">
